...
$this->title = Translate::get('Thêm cấu hình phí thanh toán');
                ...
                <div class="option-buttons">
                    <div class="addNew">
                        <a class="btn btn-danger btn-sm"
                           href="<?= Yii::$app->urlManager->createUrl('merchant-fee-default/index') ?>"><i
            ...
            <div class=col-lg-12>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class=panel-heading>
                        <h4><?= Translate::get('Thêm cấu hình phí thanh toán') ?></h4>
                    </div>
                    <div class=panel-body>
                        ...
                        <div class="form-horizontal" role=form>
                            <?php
                            $form = ActiveForm::begin(['id' => 'add-merchant-fee-default-form',
                                        'enableAjaxValidation' => true,
                                        'action' => Yii::$app->urlManager->createUrl('merchant-fee-default/add'),
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7 col-md-7">
                                        <?php
                                        echo $form->field($model, 'min_amount', ['template' => '<div class="input-group">{input}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7 col-md-7">
<?php
echo $form->field($model, 'sender_flat_fee', ['template' => '<div class="input-group">{input}
                                <span class="input-group-addon" id="basic-addon2">VND</span>
                                </div>{error}{hint}'])
        ->textInput(array('class' => 'form-control input_number', 'value' => 0))->label(false);
?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7 col-md-7">
<?php
echo $form->field($model, 'sender_percent_fee', ['template' => '<div class="input-group">{input}
...
?>
                                ...
                                <div id="receiver" class="hidden">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7 col-md-7">
<?php
echo $form->field($model, 'receiver_flat_fee', ['template' => '<div class="input-group">{input}
                                <span class="input-group-addon" id="basic-addon2">VND</span>
                                </div>{error}{hint}'])
        ->textInput(array('class' => 'form-control input_number', 'value' => 0))->label(false);
?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7 col-md-7">
<?php
echo $form->field($model, 'receiver_percent_fee', ['template' => '<div class="input-group">{input}
                                <span class="input-group-addon" id="basic-addon2">%</span>
                                </div>{error}{hint}'])
        ->textInput(array('class' => 'form-control', 'value' => 0))->label(false);
?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7 col-md-7">
                                        ...
                                        <a class="btn btn-default"
                                           href="<?= Yii::$app->urlManager->createUrl('merchant-fee-default/index') ?>"><?= Translate::get('Bỏ
                                            qua') ?></a>
                                    </div>
                                </div>
                            </div>
