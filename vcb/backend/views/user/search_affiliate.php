...
/* @var $form ActiveForm */
$this->title = 'Tìm nhân viên kinh doanh';
    ...
    <div class=row>
        <div class="col-lg-12 heading">
            <div id="page-heading" class="heading-fixed">
                <h1 class=page-header>Tìm nhân viên kinh doanh</h1>
            </div>
        </div>
    </div>
    <div class="outlet ajax-content">
        <div class="well well-sm fillter">
            <?php $form = ActiveForm::begin(['method' => 'get', 'action' => Yii::$app->urlManager->createUrl(['user/search-affiliate']), 'options' => ['class' => 'form-horizontal ajax-form', 'role' => 'form']]); ?>
            <div class="row">
                <div class="col-md-4">
            ...
            <script type="text/javascript">
                function selectId(obj, org) {
                    $('.affiliate_user_id').val($(obj).val());
                    $('#affiliate_user_name').val($(obj).attr('title'));
