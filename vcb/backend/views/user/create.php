...
?>
<?php $form = ActiveForm::begin(['id' => 'add-form', 'options' => ['enctype' => 'multipart/form-data'], 'enableAjaxValidation' => true]); ?>
    ...
    <div class=row>
        ...
        <div class="col-lg-12 heading">
            <div id="page-heading" class="heading-fixed">
                ...
                <h1 class=page-header><?= Translate::get('Thêm mới quản trị viên') ?></h1>
                <!-- Start .option-buttons -->
                <div class="option-buttons">
                    <div class="addNew">
                        <?= Html::submitButton('<i class="fa-save"></i>'. Translate::get('Lưu'), ['class' => 'btn btn-danger btn-sm', 'name' => 'add-button']) ?>
                        &nbsp;
                    ...
                    <div class=panel-body>
                        <div class="form-horizontal" role=form>
                            ...
                            <div class=form-group>
                                <label
                                    class="col-lg-2 col-md-2 col-sm-12 control-label"><?= Translate::get('Họ và tên') ?>
                                    <span
                            ...
                            <div class="form-group">
                                <label
                                    class="col-lg-2 col-md-2 col-sm-12 control-label"><?= Translate::get('Tên đăng nhập') ?>
                                    <span
                                        class="text-danger">*</span> </label>
                            ...
                            <div class="form-group">
                                <label
                                    class="col-lg-2 col-md-2 col-sm-12 control-label"><?= Translate::get('Số di động') ?>
                                    <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label
                                    class="col-lg-2 col-md-2 col-sm-12 control-label"><?= Translate::get('Số cố định') ?> </label>
                            ...
                            <div class="form-group date">
                                <label
                                    class="col-lg-2 col-md-2 col-sm-12 control-label"><?= Translate::get('Ngày sinh /Giới tính') ?></label>
