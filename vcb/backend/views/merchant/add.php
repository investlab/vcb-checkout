...
$this->title = Translate::get('Thêm mới Merchant');
            ...
            <div class=col-lg-12>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class=panel-heading>
                        <h4><?= Translate::get('Thêm mới Merchant') ?></h4>
                    </div>
                    <div class=panel-body>
                        <div class="form-horizontal" role=form>
                            <?php
                            $form = ActiveForm::begin(['id' => 'add-merchant-form',
                                'enableAjaxValidation' => true,
                                'action' => Yii::$app->urlManager->createUrl('merchant/add'),
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label"><?= Translate::get('Mật khẩu kết nối') ?> <span
                                            class="text-danger">*</span></label>

                                    <div class="col-lg-8 col-md-8">
                                        <?= $form->field($model, 'password')->label(false)
                                            ->textInput(array('class' => 'form-control', 'value'=> rand(100000,99999999))) ?>
                                    </div>
                                </div>
                                <div class="form-group">
