...
/* @var $form ActiveForm */
$this->title = 'Thêm Tỉnh-Thành/Quận-Huyện';
    ...
    <div class=row>
        <div class="col-lg-12 heading">
            <div id="page-heading" class="heading-fixed">
                <h1 class=page-header>Thêm Tỉnh-Thành/Quận-Huyện</h1>
            </div>
        </div>
    </div>
    <div class="outlet">
        <div class="form-horizontal" role=form>
            ...
            <div class="form-group">
                <label class="col-lg-3 col-md-3 col-sm-12 control-label">Tỉnh thành</label>
                <div class="col-lg-9 col-md-9">
