...
$this->title = Translate::get('Thêm yêu cầu rút tiền thẻ cào');
    ...
    <div class=row>
        ...
        <div class="col-lg-12 heading">
            <div id="page-heading" class="heading-fixed">
                ...
                <h1 class=page-header><?= Translate::get('Thêm yêu cầu rút tiền thẻ cào') ?></h1>
            ...
            <div class=col-lg-6>
                ...
                <div class="form-horizontal" role=form>
                    ...
                    $form = ActiveForm::begin(['id' => 'add-cashout-form',
                        ...
                        'action' => Yii::$app->urlManager->createUrl('cashout/add-card-transaction'),
                            ...
                            <div class="col-lg-8 col-md-8">
                                <?= $form->field($model, 'payment_method_id')->label(false)->dropDownList($payment_method_arr,
                                    [
                                        ...
                                        'data-url' => Yii::$app->urlManager->createUrl(['cashout/add-card-transaction'])
                                    ]); ?>
                            </div>
                        </div>
                    <?php if (Method::isWithdrawATMCard($method_code)) :?>
                        ...
                        <div class="form-group">
                            <label class="col-lg-4 col-md-4 col-sm-12 control-label"><?= Translate::get('Thời gian bắt đầu') ?><span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label class="col-lg-4 col-md-4 col-sm-12 control-label"><?= Translate::get('Thời gian kết thúc') ?><span
                                    class="text-danger">*</span></label>
