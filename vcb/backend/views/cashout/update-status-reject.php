...
$this->title = Translate::get('Từ chối yêu cầu rút tiền');
    ...
    <div class=row>
        <div class="col-lg-6 heading">
            <div id="page-heading" class="heading-fixed">
                <h1 class="page-header ajax-title"><?= Translate::get('Từ chối yêu cầu rút tiền') ?></h1>
            </div>
        </div>
    </div>
    <div class=outlet>
            ...
            <div class=col-lg-6>
                <div class="panel panel-primary">
                    <div class=panel-heading>
                        <h3 class=panel-title><?= Translate::get('Từ chối yêu cầu rút tiền') ?></h3>
                    </div>
                        ...
                        <div class="form-horizontal" role="form">
                            ...
                            <div class=form-group>
                                ...
                                <div class="col-lg-8 col-md-8">
                                    <input type="text" disabled class="form-control" value="<?= @$cashout['merchant_info']['name'] ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-8 col-md-8">
                                    <input type="text" disabled class="form-control" value="<?= ObjInput::makeCurrency(@$cashout['amount']) ?>">
                                </div>
                            </div>
                            <div class=form-group>
