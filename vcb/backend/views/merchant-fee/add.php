                ...
                <div class="option-buttons">
                    <div class="addNew">
                        <a class="btn btn-danger btn-sm"
                           href="<?= Yii::$app->urlManager->createUrl('merchant-fee/index') ?>"><i
                ...
                <div class="panel panel-primary">
                    ...
                    <div class=panel-body>
                        ...
                        <div class="form-horizontal" role=form>
                            <?php
                            $form = ActiveForm::begin(['id' => 'add-merchant-fee-form',
                                'enableAjaxValidation' => true,
                                'action' => Yii::$app->urlManager->createUrl('merchant-fee/add'),
                            ...
                            <div class="row">
                                ...
                                <div class=form-group>
                                    <label class="col-lg-3 col-md-3 col-sm-12 control-label">Merchant <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7 col-md-7">
                                        ...
                                        <a class="btn btn-default"
                                           href="<?= Yii::$app->urlManager->createUrl('merchant-fee/index') ?>"><?= Translate::get('Bỏ
                                            qua') ?></a>
                                    </div>
