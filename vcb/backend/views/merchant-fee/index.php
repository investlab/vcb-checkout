...
$this->title = Translate::get('Cấu hình phí thanh toán');
...
<div class=row>
    ...
    <div class="col-lg-12 heading">
        <div id="page-heading" class="heading-fixed">
            ...
            <h1 class=page-header><?= Translate::get('Cấu hình phí thanh toán') ?></h1>
            <!-- Start .option-buttons -->
            <div class="option-buttons">
                <div class="addNew">
                    <?php if (!empty($check_all_operators)) { ?>
                        <?php foreach ($check_all_operators as $key => $operator) {
                            $router = isset($operator['router']) ? $operator['router'] : 'merchant-fee/' . $key;
                            ?>
                            <?php if ($key == 'add') { ?>
                                <a href="<?= Yii::$app->urlManager->createUrl('merchant-fee/add') ?>"
    ...
    <form class="form-horizontal" role=form>
        <div class="row group-input-search">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 no-padding-left group-btn-search mobile-flex-middle-center">
                ...
                <a href="<?= Yii::$app->urlManager->createUrl('merchant-fee/index') ?>"
                                ...
                                <tr class="<?=@$array_color[$data['status']]?>">
                                    ...
                                    <td class="col-sm-3">
                                        <div class="small">
                                            ...
                                            <?php }
                                            if (isset($data['merchant_info']['name']) && $data['merchant_info']['name'] != null) { ?>
                                                <hr>
                                                Merchant : <strong
                                                    class="text-danger"><?= isset($data['merchant_info']['name']) && $data['merchant_info']['name'] != null ? $data['merchant_info']['name'] : '' ?></strong>
                                            <?php } ?>
                                        </div>
