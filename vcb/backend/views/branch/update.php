...
$this->title = Translate::get('Cập nhật chi nhánh');
        ...
        <div class=row>
            <div class="panel panel-primary">
                ...
                <div class=panel-heading>
                    <h4><?= Translate::get('Cập nhật chi nhánh') ?></h4>
                </div>
                <div class=panel-body>
                    <div class="form-horizontal" role=form>
                        <?php
                        $form = ActiveForm::begin(['id' => 'update-branch-form',
                            'enableAjaxValidation' => true,
                            'action' => Yii::$app->urlManager->createUrl('branch/update'),
