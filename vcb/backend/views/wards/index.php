...
$this->title = 'Danh sách Phường - Xã';
...
<div class=row>
    ...
    <div class="col-lg-12 heading">
        <div id="page-heading" class="heading-fixed">
            ...
            <h1 class=page-header>Danh sách Phường - Xã</h1>
...
<div class="well well-sm fillter">
    <form class="form-horizontal" role=form>
        <div class="row">
            ...
            <div class="col-md-2">
                <select class="form-control" id="city_id_search" name="city_id" onchange="wards.getDistrictByCityIDSearch();">
<!--                    <option value="0">Chọn Tỉnh - Thành Phố</option>-->
            ...
            <div class="col-md-2">
                <select class="form-control" name="district_id" id="district_id_search">
<!--                    <option value="0">Chọn Quận - Huyện</option>-->
                    <?php
                    foreach ($district_arr as $key => $data) {
                        ?>
                        <option
                            value="<?= $key ?>" <?= (isset($search) && $search->district_id == $key) ? "selected='true'" : '' ?> >
                            <?= $data ?>
                        </option>
                    <?php } ?>
                </select>
            ...
            <div class="col-md-3">
                ...
                &nbsp;
                <a href="<?= Yii::$app->urlManager->createUrl('wards/index') ?>"
    ...
    <div class=col-md-12>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php } ?>
                <form method="post"
                      action="<?= Yii::$app->urlManager->createUrl(['wards/update-position']) ?>">
                            ...
                            if (is_array($page->data) && count($page->data) > 0 && $page->errors == null) {
                                foreach ($page->data as $key => $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= isset($data['district_name']) && $data['district_name'] != null ? $data['district_name'] : '' ?>
                                        </td>
                                        <td>
                                                ...
                                                <ul class="dropdown-menu right" role="menu">
                                                    <li>
                                                        <a title="Sửa" href="#Edit" data-toggle="modal"
                                                           onclick="wards.viewEdit(
                                                               '<?= $data['id'] ?>',
                                                               '<?= Yii::$app->urlManager->createUrl('wards/view-edit') ?>'
                                                               );">
                                                            Sửa
                                                        </a>
                                                    </li>
                                                    ...
                                                    <?php if ($data['status'] == Zone::STATUS_ACTIVE) { ?>
                                                        <li>
                                                            <a onclick="wards.modalLock(
                                                                '<?= $data['id'] ?>','<?= $data['name'] ?>')"
                                                               style="cursor: pointer ">Khóa</a>
                                                        </li>
                                                    <?php } elseif ($data['status'] == Zone::STATUS_LOCK) { ?>
                                                        <li>
                                                            <a onclick="wards.modalActive(
                                                                '<?= $data['id'] ?>','<?= $data['name'] ?>')"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Kích hoạt Phường - Xã</h4>
            </div>
            <div class="modal-body">
                <!-- content in modal, tinyMCE 4 texarea -->
                <div class="form-horizontal" role="form">
                    <form id="active-wards-form" method="post"
                          action="<?= Yii::$app->urlManager->createUrl('wards/active') ?>">
                    ...
                    <div class="form-group" align="center">
                        <a class="btn btn-primary" href="javascript:wards.submitActive();">Xác
                            nhận</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title">Khóa Phường - Xã</h4>
            </div>
            <div class="modal-body">
                <!-- content in modal, tinyMCE 4 texarea -->
                <div class="form-horizontal" role="form">
                    <form id="lock-wards-form" method="post"
                          action="<?= Yii::$app->urlManager->createUrl('wards/lock') ?>">
                        <div class="alert alert-warning fade in" align="center">
                    ...
                    <div class="form-group" align="center">
                        <a class="btn btn-primary" href="javascript:wards.submitLock();">Xác
                            nhận</a>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Bỏ
                            qua
                        </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- content in modal, tinyMCE 4 texarea -->
                <?php
                $form = ActiveForm::begin(['id' => 'add-wards-form',
                    'enableAjaxValidation' => true,
                    'action' => Yii::$app->urlManager->createUrl('wards/add'),
                        ...
                        <div class="col-lg-9 col-md-9">
                            <?= $form->field($model, 'city_id')
                                ->dropDownList($city_arr, [
                                    'id' => 'city_id',
                                    'class' => 'form-control',
                                    'onchange' => 'wards.getDistrictByCityID(0,0,$("#add-wards-form"))',
                                ])->label(false) ?>
                        </div>
                    </div>
                    <div class=form-group>
                        <label class="col-lg-3 col-md-3 col-sm-12 control-label">Quận - Huyện<span
                                class="text-danger">*</span></label>

                        <div class="col-lg-9 col-md-9">
                            <?= $form->field($model, 'district_id')
                                ->dropDownList($district_arr, [
                                    'id' => 'district_id',
                                    'class' => 'form-control',
                                ])->label(false) ?>
                        </div>
...
<div class="modal fade" id="Edit" tabindex=-1 role=dialog aria-hidden=true>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Cập nhật Phường - Xã</h4>
            </div>
            <div class="modal-body">
                <!-- content in modal, tinyMCE 4 texarea -->
                <?php
                $form = ActiveForm::begin(['id' => 'edit-wards-form',
                    'enableAjaxValidation' => true,
                    'action' => Yii::$app->urlManager->createUrl('wards/update'),
                    'options' => ['enctype' => 'multipart/form-data']])
                ?>
                <div class="form-horizontal" role=form>
                    <div class=form-group>
                        ...
                        <div class="col-lg-9 col-md-9">
                            <?= $form->field($model_update, 'city_id')
                                ->dropDownList($city_arr, [
                                    'id' => 'city_id',
                                    'class' => 'form-control',
                                    'onchange' => 'wards.getDistrictByCityID(0,0,$("#edit-wards-form"))',
                                ])->label(false) ?>
                        </div>
                    </div>
                    <div class=form-group>
                        ...
                        <div class="col-lg-9 col-md-9">
                            <?= $form->field($model_update, 'parent_id')
                                ->dropDownList($district_arr, [
                                    'id' => 'district_id',
                                    'class' => 'form-control',
                                ])->label(false) ?>
...
<div style="display: none" id="url-district-ajax">
    <?php echo Yii::$app->urlManager->createUrl('wards/get-district-by-city-id'); ?>
</div>
<div style="display: none" id="url-district-search-ajax">
    <?php echo Yii::$app->urlManager->createUrl('wards/get-district-by-city-id-search'); ?>
</div>

<script type="text/javascript">
    wards.getDistrictByCityIDSearch();
    wards.getDistrictByCityID('<?php echo $city_id ?>', '<?php echo $district_id; ?>');
