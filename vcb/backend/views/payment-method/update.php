...
$this->title = Translate::get('Cập nhật phương thức thanh toán');
    ...
    <div class=row>
        ...
        <div class="col-lg-12 heading">
            <div id="page-heading" class="heading-fixed">
                ...
                <h1 class=page-header><?= Translate::get('Cập nhật phương thức thanh toán') ?></h1>
        ...
        <div class=row>
            ...
            <div class=col-lg-6>
                <div class="form-horizontal" role=form>
                    <?php
                    $form = ActiveForm::begin(['id' => 'edit-payment-method-form',
                        'enableAjaxValidation' => true,
                        'action' => Yii::$app->urlManager->createUrl('payment-method/edit'),
