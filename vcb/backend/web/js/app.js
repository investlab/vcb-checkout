...
$(document).ready(function () {
    ...
    $('body').sprFlat({
        ...
        panels: {
            moveIcon: 'im-expand',//move icon for panels
    ...
    /*$('#test').click(function() {
     $('body').data('sprFlat').checkAndRadios('green');
     });*/

    //handle panel refresh
    /* $('a.panel-refresh').click(function(){
     //get the id of panel
     panelid = $(this).closest('.panel').attr('id');
     //change content of panel
     panelbody = $('#'+panelid).find('.panel-body'));
     });*/
