                        ...
                        <tr>
                            <td>
                                <?php if (trim($checkout_order['merchant_info']['logo']) != '' && file_exists(IMAGES_MERCHANT_PATH . $checkout_order['merchant_info']['logo'])) : ?>
                                    <img class="col-sm-5"
                                         src="<?= IMAGES_MERCHANT_URL . $checkout_order['merchant_info']['logo'] ?>"
                                         style="width: 180px">
                                <?php else: ?>
                                    <img src="<?= ROOT_URL ?>/checkout/web/images/merchant_logo_default.png"
                                         style="width: 180px">
                                <?php endif; ?>
                            </td>
                            <td>
                ...
                <?php elseif ($device == 'mobile'): ?>
                    ...
                    <?php else: ?>
                        <div class="col-sm-3" style="text-align: center">
                            <?php if (trim($checkout_order['merchant_info']['logo']) != '' && file_exists(IMAGES_MERCHANT_PATH . $checkout_order['merchant_info']['logo'])) : ?>
                                <img src="<?= IMAGES_MERCHANT_URL . $checkout_order['merchant_info']['logo'] ?>"
                                     style="width: 120px;padding-bottom: 10px; padding-top: 10px">
                            <?php else: ?>
                                <img src="<?= ROOT_URL ?>/checkout/web/images/merchant_logo_default.png"
                                     style="width: 200px;padding-bottom: 10px; padding-top: 10px">
                            <?php endif; ?>
                            <br/>
