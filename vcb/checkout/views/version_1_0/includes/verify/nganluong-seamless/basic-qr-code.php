        ...
        <div class="col-sm-4 ">
            <div class="qr-code text-center" style="background: none">
                <img style="width: 75%;border: 1px solid #dcdcdc;margin: auto;"
                        src="data:image/png;base64,<?= $model->payment_transaction['partner_payment_info']['qr_data'] ?>" class="img img-responsive">
            </div>
            <p>&nbsp;</p>
            <?php if(Yii::$app->controller->action->id == 'verify' && $device == 'mobile' && ( $model->info['method_code'] == 'QR-CODE') ):?>
                ...
                <p class="text-uppercase" >
                    <button class="btn btn-primary btn-checking"
            ...
            <div class="col-sm-8 alert alert-warning">
                <div class="form-horizontal">
                    ...
                    <div class="form-group mline">
                        ...
                        <p class="text-center text-uppercase">
                            <button class="btn btn-primary btn-vcb-color btn-checking" type="button" onclick="document.location.reload();"><?= Translate::get('Kiểm tra giao dịch') ?></button>
                        </p>
                        <p>&nbsp;</p>
                    </div>
