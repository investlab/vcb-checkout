...
<div class="panel panel-default wrapCont">
    <div class="row mdevice">
        ...
        <div class="col-span-12 brdRight">
            <?php
            $form = ActiveForm::begin(['id' => 'form-checkout', 'action' => $model->getRequestV2ActionForm(), 'options' => ['class' => 'active']]);
            ...
            ?>
            <input type="hidden" id="enable-confirm" value="<?= in_array($checkout_order["merchant_id"], $GLOBALS['MERCHANT_CLICK_TO_ACCEPT_V2']) ?>">
                        ...
                        <div class="col-sm-10 text-center text-uppercase">
                            ...
                            <?php if ($model->checkout_order['merchant_id'] != 75) { ?>
                                ...
                                <div class="col-sm-12 col-md-<?= $colpayment ?> col-xs-12" id="return-btn">
                                    <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(["version_1_0/index", "token_code" => $checkout_order['token_code'], 'method_code' => $model->info['method_code']], HTTP_CODE) ?>"
        ...
        <div class="modal-dialog " role="document" style="width: 95%">
            ...
            <div class="modal-content" >
                <div class="modal-header" style="padding: 10px 30px">
                    <strong class="modal-title" id="exampleModalLabel"><?=Translate::get('Xác nhận điều khoản')?></strong>
...
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;028 3920 300 (Cục QLXNC Trụ sở Hồ Chí Minh)</p>') ?>
                ...
                <div class="modal-footer">
                    <div class="text-center">
                        <button type="button" class="btn btn-primary btn-confirm-check-in" data-link="false" id="btn-confirm"><?= Translate::get('Tôi đồng ý với điều khoản trên')?> </button>
                        <button type="button" class="btn btn-secondary btn-close-check-in" data-dismiss="modal"><?=Translate::get('Đóng lại')?></button>
                    </div>
