...
class VCCBVA
{
    ...
    public static function createVA($inputs, $form, $params): array
    {
        ...
        $inputs_call = [
            'requestId' => self::REFERENCE_NUMBER . Helpers::addZeroPrefix($account_number, 10),
            'accNameSuffix' => "NGAN LUONG",
            'partnerCode' => "NGLG",
            'accType' => "O",
            'phoneNumber' => "O936156519",
        ];
        return self::call('VCCB_VA_CREATE', $inputs_call, $params['transaction_info']['merchant_id'], $params['transaction_info']['partner_payment_id']);
...
//            curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_BASIC);
    ...
    {
        $file_name = 'partner_payment' . DS . 'vccb_va' . DS . date("Ymd", time()) . ".txt";
