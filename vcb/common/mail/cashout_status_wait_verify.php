                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="padding:18px 20px 20px 20px;vertical-align:middle;line-height:20px;font-family:Arial;background-color:#0492aa; text-align:center">
                            <span style="font-size: 115%; color: #ffffff">Xác nhận yêu cầu rút tiền</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:4px 20px 0px 20px">
                            <table width="100%">
                                <tr>
                                    <td width="50%" align="center">
                                        <a href="<?= $url_verify ?>" title="Xác nhận yêu cầu"
                                           style="display: block; background-color:#3071a9; color:#FFF; border:1px solid #285e8e; height: 25px; font-size: 13px; font-weight: 400; line-height: 25px; text-align: center; cursor: pointer; width: 150px; text-decoration: none;">Xác
                                            nhận yêu cầu</a>
                                    </td>
                                    <td width="50%" align="center">
                                        <a href="<?= $url_cancel ?>" title="Hủy yêu cầu"
                                           style="display: block; background-color:#d9534f; color:#FFF; border:1px solid #d43f3a;; height: 25px; font-size: 13px; font-weight: 400; line-height: 25px; text-align: center; cursor: pointer; width: 150px; text-decoration: none;">Hủy
                                            yêu cầu</a>
                                    </td>
                                </tr>
                            </table>
