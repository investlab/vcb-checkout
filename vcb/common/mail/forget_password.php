                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="padding:18px 20px 20px 20px;vertical-align:middle;line-height:20px;font-family:Arial;background-color:#0492aa; text-align:center">
                            <span style="font-size: 115%; color: #ffffff">Xác thực yêu cầu lấy mật khẩu đăng nhập</span></td>
                    </tr>
                    <tr>
                        <td style="padding:20px 20px 12px 20px">
                            <p>Chào <?= $fullname ?>,</p>
                            <p style="font-size: 12px;">Bạn đang yêu cầu lấy lại mật khẩu đăng nhập tài khoản Vietcombank. Để hoàn tất quy trình, xin vui lòng bấm vào đường link dưới đây hoặc copy vào thanh địa chỉ trình duyệt và nhấn Enter </p>
                            <a href="<?= $link ?>" style="font-size: 12px;text-decoration:underline"><?= $link ?></a>
                        </td>
                    </tr>
                </table>
            </td>
