...
class PartnerPaymentFeeForm extends LanguageBasicForm {
    public $id;
    ...
    public function rules()
    {
        return [
            ...
            [['method_id','partner_payment_id'], 'number', 'min' => 1, 'tooSmall' => 'Bạn phải chọn {attribute}.'],
            [['id', 'payment_method_id', 'merchant_id','partner_id'], 'integer'],
