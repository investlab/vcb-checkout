...
$this->title = 'Đổi mật khẩu đăng nhập';
                ...
                <div class="panel-body">
                    ...
                    <div class="form-horizontal pdtop2" role="form">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 col-md-3 control-label" for="formGroupInputLarge"><?=Translate::get('Mật khẩu cũ')?> <span  class="text-danger ">*</span></label>
                            <div class="col-sm-7">
                                <?= $form->field($model, 'password')->label(false)->passwordInput(array('placeholder' => Translate::get("Mật khẩu cũ")))?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 col-md-3 control-label" for="formGroupInputLarge"><?=Translate::get('Mật khẩu mới')?> <span  class="text-danger ">*</span></label>
                            <div class="col-sm-7">
                                <?= $form->field($model, 'new_password')->label(false)->passwordInput(array('placeholder' => Translate::get("Mật khẩu mới")))?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 col-md-3 control-label" for="formGroupInputLarge"><?=Translate::get('Nhập lại mật khẩu mới')?> <span  class="text-danger ">*</span></label>
                            <div class="col-sm-7">
