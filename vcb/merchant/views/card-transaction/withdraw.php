...
<div class="dropSrchbox advance clearfix" id="enhance">
    <form class="form-horizontal" role=form>
        ...
        <div>
            ...
            &nbsp;
            <a href="<?= Yii::$app->urlManager->createAbsoluteUrl('card-transaction/withdraw') ?>"
...
<div class="statistic clearfix" style="display:">
        ...
        <span class="fr">
               <a href="#" onclick="exportData.set('<?= Translate::get('Trích xuất giao dịch') ?>',
                   '<?= Yii::$app->urlManager->createAbsoluteUrl('card-transaction') . Utilities::buidLinkExcel('withdraw-export') ?>'); return false;">
                ...
                <div class="small">
                    ...
                    <?= Translate::get('Hình thức') ?>:
                        <span class="text-primary">
                             <?= isset($data['payment_method_info']['name']) && $data['payment_method_info']['name'] != null ? $data['payment_method_info']['name'] : "" ?>
                        </span><br>
                </div>
            </td>
            <td>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a class="" target="_blank"
                               href="<?= Yii::$app->urlManager->createAbsoluteUrl(['card-transaction/withdraw-detail', 'id' => $data['id']]) ?>">
                                <?= Translate::get('Chi tiết') ?>
                            </a>
                        </li>
                        <?php if ($data['status'] == Cashout::STATUS_WAIT_VERIFY) { ?>
                            <li>
                                <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['card-transaction/withdraw-verify', 'id' => $data['id']]) ?>">
                                    <?= Translate::get('Xác nhận yêu cầu') ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['card-transaction/withdraw-cancel', 'id' => $data['id']]) ?>">
