    ...
    <div class="row">
        <div class="col-md-9">			
            <div class="form-horizontal pdtop2 mform" role="form"> 
                ...
                <div class="form-group mrgb0">
                    ...
                    <div class="col-sm-8 pdr5">
                        <p class="form-control-static"><strong class="fontS14 text-primary">
                                <?= isset($cashout['amount']) && $cashout['amount'] != null ? ObjInput::makeCurrency($cashout['amount']) : 0 ?></strong> VND</p>
                    </div>
                </div>
                <div class="form-group mrgb0">
                ...
                <?php if ($cashout['status'] == Cashout::STATUS_CANCEL):?>
                <div class="form-group mrgb0">
                    <label for="" class="col-sm-4 control-label"><?=Translate::get('Lý do hủy')?>:</label>
                    <div class="col-sm-8 pdr5">
                        <p class="form-control-static">
                            <?=@$cashout['reason_info']['name']?><?= @$cashout['reason'] != '' ? '('.@$cashout['reason'].')' : '' ?>
                        </p>
                    </div>
                </div>
                <?php elseif ($cashout['status'] == Cashout::STATUS_REJECT):?>
                <div class="form-group mrgb0">
                    <label for="" class="col-sm-4 control-label"><?=Translate::get('Lý do từ chối')?>:</label>
                    <div class="col-sm-8 pdr5">
                        <p class="form-control-static">
                            <?=@$cashout['reason_info']['name']?><?= @$cashout['reason'] != '' ? '('.@$cashout['reason'].')' : '' ?>
                        </p>
