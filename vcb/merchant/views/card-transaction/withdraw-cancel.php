...
$this->title = Translate::get('Hủy yêu cầu rút tiền');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="bodyCont">
    <h1 class="titlePage"><?= Translate::get('Hủy yêu cầu rút tiền') ?></h1>
            ...
            <div class="form-horizontal pdtop2 mform" role="form">
                ...
                <div class="form-group mrgb0">
                    ...
                    <div class="col-sm-8">
                        <p class="form-control-static"><span class="text-danger">
                                ...
                                class="text-danger"><?= isset($cashout['time_end']) && intval($cashout['time_end']) > 0 ? date('H:i,d-m-Y', $cashout['time_end']) : '' ?></span>
                        </p>
                    </div>
                </div>
                <div class="form-group mrgb0">
                    <label for="inputPassword3" class="col-sm-4 control-label "><?= Translate::get('Số tiền rút') ?>
                        :</label>

                    <div class="col-sm-8 pdr5">
                        <p class="form-control-static"><strong
                                class="fontS14 text-primary"> <?= isset($cashout['amount']) && $cashout['amount'] != null ? ObjInput::makeCurrency($cashout['amount']) : 0 ?></strong>
                            VND</p>
                    </div>
                </div>
                <div class="form-group mrgb0">
                    <label for="inputPassword3" class="col-sm-4 control-label "><?= Translate::get('Phí rút') ?>
                        :</label>
                ...
                <div class="form-group mrgb0">
                    <label for="inputPassword3"
                           class="col-sm-4 control-label "><?= Translate::get('Số tiền nhận được') ?>:</label>
                ...
                <div class="form-group mrgb0">
                    <label for="inputPassword3" class="col-sm-4 control-label "><?= Translate::get('Hình thức rút') ?>
                        :</label>
                ...
                <?php $form = ActiveForm::begin(['id' => 'withdraw-cancel-form', 'options' => ['class' => 'form-horizontal p25']]); ?>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label"><?= Translate::get('Mã bảo mật') ?> <span
                    ...
                    <?= $form->field($model, 'verifyCode')->widget(\common\components\libs\MTQCaptcha::className(), [
                        ...
                        'template' => '<div class="col-sm-5">{input}</div><div class="col-sm-4 pdl5 verify-code">{image}</div><div class="col-sm-offset-3 col-sm-8">',
                    ])->label(false) ?>
                    <?= '</div>' ?>
                </div>
                <div class=form-group>
                    <label class="col-lg-3 col-md-3 col-sm-12 control-label">Lý do hủy</label>
                ...
                <div class="form-group">
                    <label class="col-lg-3 col-md-3 col-sm-12 control-label">Mô tả lý do</label>
                ...
                <div class="form-group noneMrbtm">
                    <div class="col-sm-offset-4 col-sm-3 pdr5">
                        <button type="submit"
                                class="btn btn-block btn-success"><?= Translate::get('Xác nhận') ?></button>
                    </div>
                    <div class="col-sm-3 pdl5">
                        <a href="<?= Yii::$app->urlManager->createAbsoluteUrl('card-transaction/withdraw') ?>" class="btn btn-danger"><?= Translate::get('Quay lại') ?></a>
                    </div>
                </div>
